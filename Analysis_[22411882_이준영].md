...
최근 현대인들 사이에서 정신건강 및 심리에 관한 관심이 높아졌다. 그리고 자기자신에 대해 잘 알고싶어하는 사람들도 많아졌다.

자기자신에 대해 잘 알아가는 방법으로 다양한 검사들이나 상담 등 의 방법이 있지만 시간이나 비용이 많이 들어서 부담스러운 경우들이 있다. 그래서 자기자신에 대해 잘 알아가는것에 도움이 되면서 별로 부담이 되지 않는 프로그램을 만들고자 한다.

그리고 그러한 조건을 만족할 수 있는 프로그램으로 감정일기를 작성할 수 있는 프로그램을 선택하였다. 그 이유로는 감정일기를 작성하는 것이 자신의 감정을 파악하는 것에 도움이 되고 심리적 안정을 확보하는것에 도움이 되고 자기객관화 에도 도움이 되기때문에 자기자신을 알아가는것에 도움이 되며 일기형식으로 작성을 하는 방식이기에 시간과 비용이 크지도 않으니 목적에 부합하기 떄문이다.

그리고 프로그램으로 만들면 수기로 작성하지 않고, 간단하고 자유로운 형식으로 작성을 할 수 있는 형식으로 하여서 감정일기를 쉽게 작성할 수 있다는 장점도 있어서 수기로 작성하는 아날로그적인 방식과의 차별점도 있다고 생각한다. 이러한 이유로 감정일기를 작성할 수 있는 프로그램을 만들고자 한다.
